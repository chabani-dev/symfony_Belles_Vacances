...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Resevation::class, mappedBy="users", orphanRemoval=true)
     */
    ...
    public function addReservation(Resevation $reservation): self
    {
    ...
    public function removeReservation(Resevation $reservation): self
    {
